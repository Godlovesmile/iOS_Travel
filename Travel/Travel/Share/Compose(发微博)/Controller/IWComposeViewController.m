...
- (void)sendWithImage
{
    ...
    // 3.发送请求
    [NetworkManager postWithURL:@"https://upload.api.weibo.com/2/statuses/upload.json" params:params formDataArray:formDataArray success:^(id json) {
...
- (void)sendWithoutImage
{
    ...
    // 2.发送请求
    [NetworkManager postWithURL:@"https://api.weibo.com/2/statuses/update.json" params:params success:^(id json) {
        [MBProgressHUD showSuccess:@"发送成功"];
     } failure:^(NSError *error) {
         [MBProgressHUD showError:@"发送失败"];
     }];
